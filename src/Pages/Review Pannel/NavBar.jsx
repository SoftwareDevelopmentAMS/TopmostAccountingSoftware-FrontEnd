...
const NavBar = ({handleToggleSidebar,isSidebarOpen}) => {
  return (
    <div className={`${isSidebarOpen ? "max-w-[calc(100vw-16rem)]" : "max-w-[calc(100vw-7rem)]"}  h-[4.5rem]   border text-white   bg-[#22354e] w-full relative `}>
      ...
      <div className="w-[40%]  bg-white rounded-lg overflow-hidden h-fit  relative">
        ...
        <div className="pl-5">
        <ProfileInfo NameColor={" text-white "} Profile={Profile} Name={"KrishaPriya MA"}/>
        </div>
      </div>
      </div>
    </div>
