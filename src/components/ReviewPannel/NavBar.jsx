  ...
  return (
    <div className={` h-[4.5rem]  text-NavBarText   bg-NavBar w-full relative `}>
      ...
      <div className="xs1:w-60  rounded-lg overflow-hidden  h-10   relative">
            <input
              type="text"
              className="outline-none bg-white placeholder:text-xl placeholder:text-[#C6C6C6] placeholder:opacity-50 w-full px-5 py-2"
              placeholder="Search"
            />
            <img
              alt="svgImg"
        ...
        <div className="pl-5">
        <ProfileInfo NameColor={" text-NavBarText "} Profile={Profile}  />
        </div>
      </div>
      </div>
    </div>
